program test_mesh
  ...
  ! Now test removing some cells / points
  call grid%remove_point(parr(8))
  call grid%remove_point(parr(6))
  call grid%remove_point(parr(1))
  call grid%remove_point(parr(4))
  call grid%remove_point(parr(5))
  call grid%remove_point(parr(2))
  call grid%remove_point(parr(3))
 ...
 !call grid%remove_cell(carr(10))
  call grid%remove_point(parr(9))
  call grid%remove_point(parr(10))
  call grid%remove_point(parr(11))
  call grid%remove_point(parr(7))
  print *, 'removed ok'
  call grid%print(output_unit)
